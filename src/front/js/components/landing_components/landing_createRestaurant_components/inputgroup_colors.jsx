...
export const InputGroupColors = () => {
    ...
    <div className="p-0">
        ...
        <div className="row">
            <div className="col">
                <label htmlFor="color_bg1" className="form-label">Fondo 1</label>
            ...
            <div className="col">
                <label htmlFor="color_bg2" className="form-label">Fondo 2</label>
            ...
            <div className="col">
                <label htmlFor="color_font1" className="form-label">Fuente 1</label>
            ...
            <div className="col">
                <label htmlFor="color_font2" className="form-label">Fuente 2</label>
            ...
            <div className="col">
                <label htmlFor="name" className="form-label">Hover</label>
