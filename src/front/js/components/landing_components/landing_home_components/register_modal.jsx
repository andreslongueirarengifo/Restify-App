...
const RegisterModal = () => {
  ...
  return (
    <>
      ...
      <button type="button" className="btn btn-secondary btn-restify-primary btn-rounded" data-bs-toggle="modal" data-bs-target="#registerModal" style={{fontSize:"1.25rem"}}>
        Regístrate
      </button>
