			...
			<div className="row justify-content-center  pt-5" style={styles.back2}>
					...
					<Nav defaultActiveKey="/home" className="flex-column text-center">
						<Nav.Item>
							<Nav.Link href={linkhome}>
								<p className="fs-2 fw-bold" style={styles.color1}>
									Home
								</p>
							</Nav.Link>
						</Nav.Item>
				...
				<div className=" col-10 col-md-4">
					<Nav className="flex-column text-center pb-2">
						...
						<Nav.Item>
							<a href={restaurantinfo.facebook_url} style={styles.color1}>
								<Facebook className="px-1" size="7vh" />
							</a>
							<a href={restaurantinfo.instagram_url} style={styles.color1}>
								<Instagram className="px-1" size="7vh" />
							</a>
							<a href={restaurantinfo.twitter_url} style={styles.color1}>
								<Twitter className="px-1" size="7vh" />
							</a>
						</Nav.Item>
					</Nav>
				</div>
